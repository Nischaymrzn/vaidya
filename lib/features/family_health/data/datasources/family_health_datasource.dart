...
abstract interface class IFamilyHealthRemoteDataSource {
  ...
  Future<FamilyInviteApiModel> createInvite(
    String groupId,
    Map<String, dynamic> payload,
  );
  Future<FamilyGroupApiModel> addMember(
    String groupId,
    Map<String, dynamic> payload,
  );
  ...
  Future<FamilyGroupApiModel> joinWithInvite(
    String token,
    Map<String, dynamic> payload,
  );
}
...
abstract interface class IFamilyHealthLocalDataSource {
  ...
  Future<FamilyGroupApiModel?> getGroup();
  Future<void> saveSummary(FamilyGroupSummaryApiModel data);
  Future<FamilyGroupSummaryApiModel?> getSummary();
}
